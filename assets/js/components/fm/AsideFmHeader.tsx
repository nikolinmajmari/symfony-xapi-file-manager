...
import { createFolder, uploadToSnapshot } from "../../features/snapshot/snapshotSlice";
import { IconButton } from "../buttons/IconButton";
import {useDropzone} from "react-dropzone";
import { FileUploadModal } from "./DropZone";
...
export function AsideFMHeader() {
  ...
  return (
    <div className="action-field flex flex-row flex-wrap justify-end items-start">
      ...
      {
        showFileUploadModal?(
          <FileUploadModal showModal={showModal} setShowModal={setShowFileUploadModal}/>
        ):(<></>)
      }
      <div className="mx-1"></div>
      <div onClick={()=>setShowFileUploadModal(true)}>
